...
slope.summary <- read_csv("data/snp_change_2/mean_median_S_env578.csv") %>% select(Site, Median, Mean)
...
ggsave("Graphs/Demography_2/02_median_slope_lambda_CMD_Tave_PPT.pdf",width=8, height = 6, units = "in")
