...
## Extreme cut off average slope 0.04 and 0.96 
## Done for slopes >0.3
## 
## 
...
#ggsave("Graphs/snp_change/extreme_cuttoff/7_03_spaghetii_baseline_lat_03.pdf",width=8, height = 7, units = "in")
...
ggsave("Graphs/snp_change/extreme_cuttoff/03_extreme_cuttoff_04.pdf",arrg_1,width=8, height = 7, units = "in")
