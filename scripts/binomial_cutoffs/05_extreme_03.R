...
## Has only SNPs with a linear correlation with climate variables with the following cut offs:
## Extreme cut off average slope 0.03 and 0.97 
## Slopes >0.3
## 
...
abund_clim <- read_csv("/Users/daniel_anstett/Dropbox/z_Documents/aLarge_files/M_gen/abund_table_baseline_slope_SE_std_03.csv",
                       col_names = T)
...
write_csv(abund_env1_rm[,1],"data/snp_change_data/strong_snp_set_env1.csv")
write_csv(abund_env2_rm[,1],"data/snp_change_data/strong_snp_set_env2.csv")
write_csv(abund_env3_rm[,1],"data/snp_change_data/strong_snp_set_env3.csv")
write_csv(abund_env4_rm[,1],"data/snp_change_data/strong_snp_set_env4.csv")
write_csv(abund_env5_rm[,1],"data/snp_change_data/strong_snp_set_env5.csv")
write_csv(abund_env6_rm[,1],"data/snp_change_data/strong_snp_set_env6.csv")
write_csv(abund_env7_rm[,1],"data/snp_change_data/strong_snp_set_env7.csv")
write_csv(abund_env8_rm[,1],"data/snp_change_data/strong_snp_set_env8.csv")
write_csv(abund_env9_rm[,1],"data/snp_change_data/strong_snp_set_env9.csv")
write_csv(strong_snp_set,"data/snp_change_data/strong_snp_set.csv")
...
#ggsave("Graphs/extreme_cuttoff/base_slope_cutoff/7_03_spaghetii_baseline_lat_03.pdf",width=8, height = 7, units = "in")
...
ggsave("Graphs/snp_change/extreme_cuttoff/03_extreme_cuttoff_03.pdf",arrg_1,width=8, height = 7, units = "in")
