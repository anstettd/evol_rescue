##################################################################################
## Plot SNP frequency for all baseline populations, slope cutoff >0.2
...
abund_clim <- read_csv("/Users/daniel_anstett/Dropbox/z_Documents/aLarge_files/M_gen/abund_table_baseline_slope_SE_std_02.csv",
                       col_names = T)
...
#ggsave("Graphs/snp_change/base_slope_cutoff/7_02_spaghetii_baseline_lat_02.pdf",width=8, height = 7, units = "in")
...
ggsave("Graphs/snp_change/base_slope_cutoff/02_spaghetii_baseline_env_std.pdf",arrg_1,width=8, height = 7, units = "in")
