...
ggsave("Graphs/snp_change_2/05_spaghetii_obs_S6.pdf",width=8, height = 7, units = "in")
...
ggsave("Graphs/snp_change_2/06_spaghetii_obs_2E.pdf",width=4, height = 4, units = "in")
