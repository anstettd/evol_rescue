...
MAP_plot
ggsave("Graphs/Climate/Timeseries/MAP_pop.pdf",width=6, height = 8, units = "in")



#*******************************************************************************
### 3. Make climate anomaly timeseries
#*******************************************************************************
...
ggsave("graphs/Climate/Anomaly/MAP_time.pdf",width=12, height = 8, units = "in")
...
ggplot(anom, aes(x=Year, y=PPT_wt.anom))+
  ...
  facet_wrap(~Lat.Site, scale="free", nrow=5) + #theme_classic() #+
  theme_ci()#+
ggsave("graphs/Climate/Anomaly/PPT_wt_time.pdf",width=12, height = 8, units = "in")
...
#*******************************************************************************
### 4. Visualize drought anomaly, not currently used in paper
#*******************************************************************************
...
#ggsave("graphs/Climate/Anomaly/PPT_wt_pop.pdf",width=6, height = 8, units = "in")


# plot Year vs. PPT_wt anom
PPT_wt_plot<-ggplot() + 
...
#scale_x_discrete(labels=Site.label)
PPT_wt_plot
#ggsave("Graphs/Climate/Anomaly/PPT_wt_anomaly.pdf",width=6, height = 8, units = "in")
