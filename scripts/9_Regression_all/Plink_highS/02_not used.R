...
snp_set_env1 <- read_csv("data/snp_change_data/strong_snp_set_env1.csv") %>% select(chr_snp)
snp_set_env2 <- read_csv("data/snp_change_data/strong_snp_set_env2.csv") %>% select(chr_snp)
snp_set_env3 <- read_csv("data/snp_change_data/strong_snp_set_env3.csv") %>% select(chr_snp)
snp_set_env4 <- read_csv("data/snp_change_data/strong_snp_set_env4.csv") %>% select(chr_snp)
snp_set_env5 <- read_csv("data/snp_change_data/strong_snp_set_env5.csv") %>% select(chr_snp)
snp_set_env6 <- read_csv("data/snp_change_data/strong_snp_set_env6.csv") %>% select(chr_snp)
snp_set_env7 <- read_csv("data/snp_change_data/strong_snp_set_env7.csv") %>% select(chr_snp)
snp_set_env8 <- read_csv("data/snp_change_data/strong_snp_set_env8.csv") %>% select(chr_snp)
snp_set_env9 <- read_csv("data/snp_change_data/strong_snp_set_env9.csv") %>% select(chr_snp)

#Import SNP abundance table for 55 baseline populations per env variable
snp_set_abundance_env1 <- read_csv("data/genomic_data/snp_set_abundance_env1.csv")
snp_set_abundance_env2 <- read_csv("data/genomic_data/snp_set_abundance_env2.csv") 
snp_set_abundance_env3 <- read_csv("data/genomic_data/snp_set_abundance_env3.csv") 
snp_set_abundance_env4 <- read_csv("data/genomic_data/snp_set_abundance_env4.csv") 
snp_set_abundance_env5 <- read_csv("data/genomic_data/snp_set_abundance_env5.csv") 
snp_set_abundance_env6 <- read_csv("data/genomic_data/snp_set_abundance_env6.csv") 
snp_set_abundance_env7 <- read_csv("data/genomic_data/snp_set_abundance_env7.csv") 
snp_set_abundance_env8 <- read_csv("data/genomic_data/snp_set_abundance_env8.csv") 
snp_set_abundance_env9 <- read_csv("data/genomic_data/snp_set_abundance_env9.csv") 
...
write_tsv(snp_set_env1_all,"data/genomic_data/plink_input_env1.tsv")
write_tsv(snp_set_env2_all,"data/genomic_data/plink_input_env2.tsv")
write_tsv(snp_set_env3_all,"data/genomic_data/plink_input_env3.tsv")
write_tsv(snp_set_env4_all,"data/genomic_data/plink_input_env4.tsv")
write_tsv(snp_set_env5_all,"data/genomic_data/plink_input_env5.tsv")
write_tsv(snp_set_env6_all,"data/genomic_data/plink_input_env6.tsv")
write_tsv(snp_set_env7_all,"data/genomic_data/plink_input_env7.tsv")
write_tsv(snp_set_env8_all,"data/genomic_data/plink_input_env8.tsv")
write_tsv(snp_set_env9_all,"data/genomic_data/plink_input_env9.tsv")
