##################################################################################
## Plot SNP frequency for all baseline populations with removal of extreme values 
## Extreme cut off average slope 0.05 and 0.95
## Done for slopes >0.3
## 
## 
...
#ggsave("Graphs/snp_change/extreme_cuttoff/base_slope_cutoff/7_03_spaghetii_baseline_lat_03.pdf",width=8, height = 7, units = "in")
...
ggsave("Graphs/snp_change/extreme_cuttoff/03_extreme_cuttoff_05.pdf",arrg_1,width=8, height = 7, units = "in")
