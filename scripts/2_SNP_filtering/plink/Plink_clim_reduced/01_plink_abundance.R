...
write_csv(snp_set_abundance_env1,"data/genomic_data/snp_set_abundance_env1.csv")
write_csv(snp_set_abundance_env2,"data/genomic_data/snp_set_abundance_env2.csv")  
write_csv(snp_set_abundance_env3,"data/genomic_data/snp_set_abundance_env3.csv")  
write_csv(snp_set_abundance_env4,"data/genomic_data/snp_set_abundance_env4.csv")  
write_csv(snp_set_abundance_env5,"data/genomic_data/snp_set_abundance_env5.csv")  
write_csv(snp_set_abundance_env6,"data/genomic_data/snp_set_abundance_env6.csv")  
write_csv(snp_set_abundance_env7,"data/genomic_data/snp_set_abundance_env7.csv")  
write_csv(snp_set_abundance_env8,"data/genomic_data/snp_set_abundance_env8.csv")  
write_csv(snp_set_abundance_env9,"data/genomic_data/snp_set_abundance_env9.csv")  
