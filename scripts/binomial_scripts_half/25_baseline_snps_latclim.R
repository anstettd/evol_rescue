...
snp1_time <- read_csv("data/snp_set_uncalibrated_time_env1.csv")
snp2_time <- read_csv("data/snp_set_uncalibrated_time_env2.csv")
snp3_time <- read_csv("data/snp_set_uncalibrated_time_env3.csv")
snp4_time <- read_csv("data/snp_set_uncalibrated_time_env4.csv")
snp5_time <- read_csv("data/snp_set_uncalibrated_time_env5.csv")
snp6_time <- read_csv("data/snp_set_uncalibrated_time_env6.csv")
snp7_time <- read_csv("data/snp_set_uncalibrated_time_env7.csv")
snp8_time <- read_csv("data/snp_set_uncalibrated_time_env8.csv")
snp9_time <- read_csv("data/snp_set_uncalibrated_time_env9.csv")

#Baseline SNP abundances
env1_base <- read_csv("data/snp_set_uncalibrated_base_env1.csv")
env2_base <- read_csv("data/snp_set_uncalibrated_base_env2.csv")
env3_base <- read_csv("data/snp_set_uncalibrated_base_env3.csv")
env4_base <- read_csv("data/snp_set_uncalibrated_base_env4.csv")
env5_base <- read_csv("data/snp_set_uncalibrated_base_env5.csv")
env6_base <- read_csv("data/snp_set_uncalibrated_base_env6.csv")
env7_base <- read_csv("data/snp_set_uncalibrated_base_env7.csv")
env8_base <- read_csv("data/snp_set_uncalibrated_base_env8.csv")
env9_base <- read_csv("data/snp_set_uncalibrated_base_env9.csv")
