##################################################################################
## Plot SNP frequency for all baseline populations, slope cutoff >0.3
...
#ggsave("Graphs/snp_change/base_slope_cutoff/7_03_spaghetii_baseline_lat_03.pdf",width=8, height = 7, units = "in")
...
ggsave("Graphs/snp_change/base_slope_cutoff/03_spaghetii_baseline_env_std.pdf",arrg_1,width=8, height = 7, units = "in")
